<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Admin-InsertTote.aspx.cs" Inherits="Admin_InsertTote" %>
        ...
        <div class="insertcontainer">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox Style="width: 20%; height: 30px; border: 0.5px solid" ID="txtToteID" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtToteName" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox  Style="width: 100%; height: 80px; border: 0.5px solid" ID="txtToteDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox Style="width: 30%; height: 30px; border: 0.5px solid" ID="txtTotePrice" runat="server" ></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtToteType" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
