<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Admin-InsertShoulder.aspx.cs" Inherits="Admin_InsertShoulder" %>
        ...
        <div class="insertcontainer">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox Style="width: 20%; height: 30px; border: 0.5px solid" ID="txtShoulderID" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtShoulderName" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox  Style="width: 100%; height: 80px; border: 0.5px solid" ID="txtShoulderDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox Style="width: 30%; height: 30px; border: 0.5px solid" ID="txtShoulderPrice" runat="server" ></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtShoulderType" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
