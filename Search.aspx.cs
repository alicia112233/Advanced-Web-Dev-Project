...
public partial class Search : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string checksearch = "SELECT COUNT(*) FROM [ALL_Products] WHERE Title LIKE @search OR Type LIKE @search";
            ...
            if (temp > 0)
            {
                ...
                strCommandText += " FROM ALL_Products WHERE Title LIKE @title OR Type LIKE @type";
                ...
                cmd.Parameters["@type"].Value = "%" + txtSearch.Text + "%";
