<%@ Page Title="" Language="C#" MasterPageFile="~/Afterlogin.master" AutoEventWireup="true" CodeFile="ViewCart2.aspx.cs" Inherits="ViewCart2" %>
    ...
    <body>
                                        ...
                                        <table>
                                            <tr style="border: none">
                                                <td style="border: none">
                                                    ...
                                                    by
                                                    <asp:Label
                                                        Style="font-family: 'Poppins', sans-serif; font-size: 14px; color: #BF94E4"
                                                        ID="lblAuthor"
                                                        runat="server"
                                                        Text='<%#Eval ("Bag_Type") %>'>
                                                    </asp:Label>
                                            ...
                                            <tr style="border: none;">
                                                <td>
                                                    <p style="font-size: 11px; float: left">Choose Expedited Shipping at checkout for guaranteed delivery within 2-3 days</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
        ...
        <div class="ordersummary">
            ...
            <div class="checkout" style="width: 100%; float: left; border-top: 0.5px solid black; border-bottom: 0.5px solid black;">
                ...
                <asp:Button ID="btnCheckOut" type="button" runat="server" Text="CHECKOUT" class="checkoutbtn" style="cursor: pointer;" OnClick="btnCheckOut_Click" />
                                ...
                                <table>
                                    <tr style="border: none">
                                        <td style="border: none">
                                            ...
                                            <br></br>
                                            by
                                            <asp:Label Style="font-family: 'Poppins', sans-serif; font-size: 10px; color: #BF94E4" ID="lblAuthor" runat="server" Text='<%#Eval ("Product_Author") %>'></asp:Label>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="border: none;">
                                        <td style="font-size: 12px;">
                                            <asp:LinkButton Style="color: #b3b3ff;" ID="linkRemove" runat="server" CommandArgument='<%# Eval("ItemID") %>' CommandName="Remove" Text="Remove"></asp:LinkButton>
                                        </td>
                                    </tr>
