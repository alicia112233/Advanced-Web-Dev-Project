        ...
        <div class="paymentcontainer">
            ...
            <div class="shipping">
                ...
                <asp:TextBox ID="txtZipCode" runat="server" CssClass="shippingtxt"
                    PlaceHolder="Zip Code" Style="width: 49%; float: left; margin-top: 20px"></asp:TextBox>
                <asp:TextBox ID="txtPhoneNumber" runat="server" CssClass="shippingtxt"
                    PlaceHolder="Phone Number" Style="width: 49%; float: right; margin-top: 20px"></asp:TextBox>
            </div>
            <br />
            ...
            <div class="billing">
                ...
                <asp:TextBox ID="txtNameOnCard" runat="server" CssClass="shippingtxt" PlaceHolder="Name on Card" ></asp:TextBox>
        ...
        <div class="rightcontainer">
            <div class="ordersummary">
                ...
                <div class="checkout" style="width: 100%; float: left; border-top: 0.5px solid black; border-bottom: 0.5px solid black;">
                    ...
                    <asp:Button ID="btnSubmitOrder" runat="server" Text="SUBMIT ORDER" style="cursor: pointer;" class="checkoutbtn" OnClick="btnSubmitOrder_Click" />
                </div>
