<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Admin-InsertBackpacks.aspx.cs" Inherits="Admin_InsertBackpacks" %>
        ...
        <div class="insertcontainer">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox Style="width: 20%; height: 30px; border: 0.5px solid" ID="txtBackpackID" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtBackpackName" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox  Style="width: 100%; height: 80px; border: 0.5px solid" ID="txtBackpackDesc" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox Style="width: 30%; height: 30px; border: 0.5px solid" ID="txtBackpackPrice" runat="server" ></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="textboxes" ID="txtBackpackType" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
